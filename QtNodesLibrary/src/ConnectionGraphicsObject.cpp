...
void ConnectionGraphicsObject::setHighlight(bool enabled) {
    if (enabled) {
        _highlightColor = QColor("red");
        _highlightLineWidth = 5.0;
    } else {
        _highlightColor = QColor("gray");
        _highlightLineWidth = 3.0;
    }
    update(); // force le repaint de la connexion
}
