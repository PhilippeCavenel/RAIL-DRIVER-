...
void NodeGraphicsObject::setHighlight(bool enabled)
{
    if (enabled)
        _highlightBackground = QColor("red");
    else
        _highlightBackground = QColor();  // valeur invalide = couleur par défaut

    update();  // redessine le nœud avec la nouvelle couleur
}
