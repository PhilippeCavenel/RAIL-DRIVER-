#ifndef INNOMAKERMAINWINDOW_H
#define INNOMAKERMAINWINDOW_H
...
QT_BEGIN_NAMESPACE
namespace Ui { class InnoMakerMainWindow; }
QT_END_NAMESPACE

DEFINE_GUID( GUID_USB2CAN  ,0x88bae032, 0x5a81, 0x49f0, 0xbc, 0x3d, 0xa4, 0xff, 0x13, 0x82, 0x16, 0xd6);
class InnoMakerMainWindow : public QMainWindow
{
    Q_OBJECT

public:
    InnoMakerMainWindow(QWidget *parent = nullptr);
    ~InnoMakerMainWindow();
...
signals:
    void characterReceived(unsigned char c,QString TimeStamp,int frameId);
