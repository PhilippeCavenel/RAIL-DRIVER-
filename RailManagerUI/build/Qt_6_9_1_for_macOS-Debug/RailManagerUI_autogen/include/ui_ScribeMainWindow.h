...
public:
    ...
    void setupUi(QMainWindow *ScribeMainWindow)
    {
        ...
        gridLayout->addWidget(CommandResult, 1, 8, 2, 2);
        ...
        gridLayout->addWidget(sendAgainButton, 2, 6, 1, 1);
